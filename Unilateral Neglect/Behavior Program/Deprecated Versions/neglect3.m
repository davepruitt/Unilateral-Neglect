...
handles.stage_settings_path = 'https://docs.google.com/spreadsheet/pub?key=0AhzLNWqYl6P4dHdXQ0s1VEtHN0J2dWlmMzBYOXNtM3c&output=txt';
...
h.psychometric_cue_intensities = [255 128 64 32 16 8 4 2 1];
...
fields = {'Stage Number', 'number'; ...
    ...
    'Cue Intensity (0 to 1)', 'cueintensity'; ...
